...
import type { DiskStorageFile, MemoryStorageFile, Storage, StorageFile, StreamStorageFile } from '../storage';
import type { UploadOptions } from './options';

export type UploadFilterFile = DiskStorageFile | MemoryStorageFile | StreamStorageFile | StorageFile;
