...
export type FastifyMultipartRequest<F extends StorageFile = StorageFile> = FastifyRequest<
...
export const getParts = <S extends Storage>(req: FastifyRequest, options: UploadOptions<S>): MultipartsIterator => {
