...
| [MCP-Server](./packages/nestjs-mcp-server/README.md)            | A NestJS module to build [Model Context Protocol] servers idiomatically. | [![npm](https://img.shields.io/npm/v/@getlarge/nestjs-mcp-server?style=flat)](https://npmjs.org/package/@getlarge/nestjs-mcp-server)                               |
